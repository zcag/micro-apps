...
<body>
  ...
  <div class="grid">
    ...
    <!-- Wave 8 -->
    <a class="card" href="./diff-checker/" style="--accent:#7C3AED">
      <div class="card-header">
        <span class="dot" style="background:#7C3AED"></span>
        <h2>Text Diff Checker</h2>
      </div>
      <p>Compare two texts side-by-side with highlighted differences, additions, and deletions.</p>
    </a>

    <a class="card" href="./hash-gen/" style="--accent:#0891B2">
      <div class="card-header">
        <span class="dot" style="background:#0891B2"></span>
        <h2>Hash Generator</h2>
      </div>
      <p>Generate MD5, SHA-1, SHA-256, and SHA-512 hashes from text or files instantly.</p>
    </a>

    <a class="card" href="./timestamp/" style="--accent:#F97316">
      <div class="card-header">
        <span class="dot" style="background:#F97316"></span>
        <h2>Timestamp Converter</h2>
      </div>
      <p>Convert between Unix timestamps and human-readable dates across time zones.</p>
    </a>

    <a class="card" href="./csv-json/" style="--accent:#16A34A">
      <div class="card-header">
        <span class="dot" style="background:#16A34A"></span>
        <h2>CSV to JSON Converter</h2>
      </div>
      <p>Convert between CSV and JSON formats with live preview, validation, and download.</p>
    </a>

    <a class="card" href="./contrast-check/" style="--accent:#6366F1">
      <div class="card-header">
        <span class="dot" style="background:#6366F1"></span>
